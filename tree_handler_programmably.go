...
var (
	// ErrNilNode is returned if the argument *gtree.Node of OutputFromRoot / MkdirFromRoot / VerifyFromRoot / WalkFromRoot / WalkIterFromRoot function is nill.
	ErrNilNode = errors.New("nil node")
	// ErrNotRoot is returned if the argument *gtree.Node of OutputFromRoot / MkdirFromRoot / VerifyFromRoot / WalkFromRoot / WalkIterFromRoot function is not root of the tree.
...
func OutputProgrammably(w io.Writer, root *Node, options ...Option) error {
	return OutputFromRoot(w, root, options...)
}
...
func MkdirProgrammably(root *Node, options ...Option) error {
	return MkdirFromRoot(root, options...)
}
...
func VerifyProgrammably(root *Node, options ...Option) error {
	return VerifyFromRoot(root, options...)
}
...
func WalkProgrammably(root *Node, callback func(*WalkerNode) error, options ...Option) error {
	return WalkFromRoot(root, callback, options...)
}
...
func WalkIterProgrammably(root *Node, options ...Option) iter.Seq2[*WalkerNode, error] {
	return WalkIterFromRoot(root, options...)
}
